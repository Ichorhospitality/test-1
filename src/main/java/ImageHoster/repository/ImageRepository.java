...
public class ImageRepository {
    ...
    //NEW CHANGES
    /*
        Earlier the Code was fetching the image using the image Title as the identifier with the new changes the code
        now uses image ID as the unique identifier to fetch the image from database. The ImageID is more suitable
        as identifier as it would be unique to the corresponding image.
     */
